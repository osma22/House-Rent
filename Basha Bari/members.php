...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Basha Bari</a>
    </div>
...
{
 echo "<tr><td>".$result['t_id']."</td><td>".$result['fname']."</td><td>".$result['lname']."</td><td>".$result['gender']."</td><td>".$result['occupation']."</td><td>".$result['relationship']."</td></tr>";
}
echo "</table>";
?>
</div>
